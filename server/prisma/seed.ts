...
async function main() {
  ...
  const plans = [
    ...
    { name: "Starter (Monthly)", slug: "starter", price: 99900, interval: "month", sortOrder: 1, creditsLimit: 300, businessLimit: 1, teamSeats: 2, features: ["1 business", "300 Credits/mo", "Review collection (email + QR + SMS)", "Review inbox (Google + Facebook)", "AI reply drafting", "Review insights & sentiment", "Unlimited QR codes", "Priority support"], description: "For single-location businesses." },
    { name: "Starter (Yearly)", slug: "starter-yearly", price: 999900, interval: "year", sortOrder: 2, creditsLimit: 300, businessLimit: 1, teamSeats: 2, features: ["1 business", "300 Credits/mo", "Everything in Starter monthly", "Save ₹1,989 vs monthly"], description: "Billed annually. Save ~₹1,989/yr." },
    { name: "Growth (Monthly)", slug: "growth", price: 249900, interval: "month", sortOrder: 3, creditsLimit: 1500, businessLimit: 3, teamSeats: 5, features: ["Up to 3 businesses", "1,500 Credits/mo", "Everything in Starter", "SMS review collection", "AI review insights & sentiment", "Review widgets for website", "Priority support"], description: "For growing businesses." },
    { name: "Growth (Yearly)", slug: "growth-yearly", price: 2499900, interval: "year", sortOrder: 4, creditsLimit: 1500, businessLimit: 3, teamSeats: 5, features: ["Up to 3 businesses", "1,500 Credits/mo", "Everything in Growth monthly", "Save ₹4,989 vs monthly"], description: "Billed annually. Save ~₹4,989/yr." },
    { name: "Pro (Monthly)", slug: "pro", price: 499900, interval: "month", sortOrder: 5, creditsLimit: 5000, businessLimit: 10, teamSeats: 15, features: ["Up to 10 businesses", "5,000 Credits/mo", "Everything in Growth", "WhatsApp review collection", "Team roles (15 users)", "Custom branding", "Google Business Profile sync", "Dedicated support"], description: "For multi-location businesses." },
    { name: "Pro (Yearly)", slug: "pro-yearly", price: 4999900, interval: "year", sortOrder: 6, creditsLimit: 5000, businessLimit: 10, teamSeats: 15, features: ["Up to 10 businesses", "5,000 Credits/mo", "Everything in Pro monthly", "Save ₹9,989 vs monthly"], description: "Billed annually. Save ~₹9,989/yr." },
  ];
