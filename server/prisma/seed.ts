...
async function main() {
  ...
  const plans = [
    { name: "Free", slug: "free", price: 0, sortOrder: 0, creditsLimit: 30, businessLimit: 1, teamSeats: 1, features: ["1 business", "30 Credits/mo", "Review collection (email + QR)", "Review inbox (Google)", "Basic analytics"], description: "For businesses just getting started." },
    { name: "Lite (Monthly)", slug: "lite", price: 10000, interval: "month", sortOrder: 1, creditsLimit: 100, businessLimit: 1, teamSeats: 1, features: ["1 business", "100 Credits/mo", "Review collection (email + QR)", "Review inbox (Google)", "Basic analytics", "Priority email support"], description: "Affordable entry-level plan." },
    { name: "Lite (Yearly)", slug: "lite-yearly", price: 120000, interval: "year", sortOrder: 2, creditsLimit: 100, businessLimit: 1, teamSeats: 1, features: ["1 business", "100 Credits/mo", "Everything in Lite monthly", "Save ₹1,200 vs monthly"], description: "Billed annually. Save ~₹1,200/yr." },
    { name: "Starter (Monthly)", slug: "starter", price: 24900, interval: "month", sortOrder: 3, creditsLimit: 300, businessLimit: 1, teamSeats: 2, features: ["1 business", "300 Credits/mo", "Review collection (email + QR + SMS)", "Review inbox (Google + Facebook)", "AI reply drafting", "Review insights & sentiment", "Unlimited QR codes", "Priority support"], description: "For single-location businesses." },
    { name: "Starter (Yearly)", slug: "starter-yearly", price: 249900, interval: "year", sortOrder: 4, creditsLimit: 300, businessLimit: 1, teamSeats: 2, features: ["1 business", "300 Credits/mo", "Everything in Starter monthly", "Save ₹489 vs monthly"], description: "Billed annually. Save ~₹489/yr." },
    { name: "Growth (Monthly)", slug: "growth", price: 49900, interval: "month", sortOrder: 5, creditsLimit: 1500, businessLimit: 3, teamSeats: 5, features: ["Up to 3 businesses", "1,500 Credits/mo", "Everything in Starter", "SMS review collection", "AI review insights & sentiment", "Review widgets for website", "Priority support"], description: "For growing businesses." },
    { name: "Growth (Yearly)", slug: "growth-yearly", price: 499900, interval: "year", sortOrder: 6, creditsLimit: 1500, businessLimit: 3, teamSeats: 5, features: ["Up to 3 businesses", "1,500 Credits/mo", "Everything in Growth monthly", "Save ₹989 vs monthly"], description: "Billed annually. Save ~₹989/yr." },
    { name: "Pro (Monthly)", slug: "pro", price: 79900, interval: "month", sortOrder: 7, creditsLimit: 5000, businessLimit: 10, teamSeats: 15, features: ["Up to 10 businesses", "5,000 Credits/mo", "Everything in Growth", "WhatsApp review collection", "Team roles (15 users)", "Custom branding", "Google Business Profile sync", "Dedicated support"], description: "For multi-location businesses." },
    { name: "Pro (Yearly)", slug: "pro-yearly", price: 799900, interval: "year", sortOrder: 8, creditsLimit: 5000, businessLimit: 10, teamSeats: 15, features: ["Up to 10 businesses", "5,000 Credits/mo", "Everything in Pro monthly", "Save ₹1,589 vs monthly"], description: "Billed annually. Save ~₹1,589/yr." },
  ];
