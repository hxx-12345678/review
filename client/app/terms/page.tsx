    ...
    <div className="flex min-h-screen min-w-0 flex-col">
      ...
      <main className="mx-auto w-full max-w-3xl flex-1 min-w-0 overflow-hidden px-4 py-10 sm:px-6 sm:py-16">
        ...
        <section className="mb-8 space-y-4">
          ...
          <p>
            The Service is offered on a subscription basis in INR. Current plans are listed on our{" "}
            <a href="/pricing" className="text-primary underline underline-offset-2">pricing page</a>:
            Free (₹0), Lite (₹100/month), Starter (₹249/month), Growth (₹499/month), Pro (₹799/month),
            with yearly options. Payment is processed by Razorpay (UPI, cards); GST invoice is provided and
        ...
        <section className="mb-8 space-y-4">
          ...
          <p>
            If you use SMS messaging features in India, you are responsible for TRAI requirements, including
            principal-entity registration, registered headers/templates (DLT), and prior consent for promotional
            communication, plus honoring opt-outs. WhatsApp Business messaging additionally needs customer/owner
            opt-in and approved Meta templates in the correct category (utility vs marketing); no WhatsApp delivery
            occurs until you connect your number and complete opt-in.
          </p>
        </section>

        <section className="mb-8 space-y-4">
          <h2 className="text-xl font-semibold">9. AI Features &amp; Subprocessors</h2>
          <p>
            The Service includes AI-powered features such as talking point generation, review draft creation,
            owner-reply drafting, and insights. Inference is provided by Google Gemini; offline deterministic
            fallbacks apply when AI is unreachable (drafts then follow your selected language from built-in templates).
          </p>
          <ul className="list-disc space-y-2 pl-6">
            ...
            <li>Relevant feedback text you submit to AI features is transmitted to Google for inference only; we do not authorize training use. Deletion requests are propagated per processor terms.</li>
        ...
        <section className="mb-8 space-y-4">
          <h2 className="text-xl font-semibold">16. Governing Law &amp; Grievance</h2>
          <p>
            These Terms are governed by the laws of India. Disputes are subject to the exclusive jurisdiction
            of the courts at Bengaluru, Karnataka. Nothing here limits your rights under the DPDP Act 2023
            (including grievance redressal via privacy@beyondvyu.com and the Data Protection Board of India)
            or under applicable Indian consumer protection law.
          </p>
          <p>
