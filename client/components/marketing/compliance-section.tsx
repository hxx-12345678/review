        ...
        <div className="grid gap-14 lg:grid-cols-2 lg:gap-20">
          ...
          <div className="reveal-left">
            ...
            <h2 className="mt-5 text-balance text-4xl font-bold tracking-[-0.025em] text-foreground sm:text-5xl">
              Genuine reviews, without gaming the system
            </h2>

            <p className="mt-4 text-pretty text-lg leading-relaxed text-muted-foreground">
              Google allows asking customers for reviews via a link or QR code — but prohibits incentives,
              gating, pressure, and steering content. BEYONDVYU gives every customer the same path and keeps
              prompts open-ended, so growth never puts your profile at risk.
            </p>
            ...
            <div className="mt-10 grid gap-4 sm:grid-cols-2">
              <Comparison
                negative
                title="Risky patterns we avoid"
                items={[
                  "Writing or copy-paste reviews for customers",
                  "Showing Google link only to happy customers",
                  "Prompting staff names or specific content",
                ]}
              />
              <Comparison
                title="What BEYONDVYU does"
                items={[
                  "Reminders from the customer's own words only",
                  "Same link for every customer, every rating",
                  "Open-ended prompts; customer edits & owns final text",
                ]}
              />
            </div>
            ...
            <div className="mt-6 rounded-2xl border border-destructive/20 border-l-4 border-l-destructive bg-card p-4 shadow-[0_1px_3px_rgba(0,0,0,0.04),0_6px_24px_rgba(0,0,0,0.05)]">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-sm font-bold text-foreground">Google actively removes policy-violating reviews</p>
                  <p className="mt-1 text-xs leading-relaxed text-muted-foreground">
                    Google&apos;s 2025 Trust & Safety enforcement blocked ~292M policy-violating reviews, and April 2026
                    updates explicitly ban staff quotas and staff-name/content steering. Incentives, gating and on-premises
                    pressure are also prohibited. US FTC Rule (16 C.F.R. Part 465, Oct 2024) adds penalties for fake reviews
                    for US activity — in India, DPDP Act consent + TRAI messaging rules apply.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-4 stagger-children">
            ...
            <div className="reveal mt-6 rounded-2xl border border-border/60 bg-card p-6 shadow-[0_1px_3px_rgba(0,0,0,0.04),0_6px_24px_rgba(0,0,0,0.05)]">
              <div className="grid grid-cols-3 gap-4">
                {[
                  { icon: ShieldCheck, label: "Google-aligned" },
                  { icon: Scale, label: "DPDP-ready" },
                  { icon: Eye, label: "Consent-first" },
                ].map(({ icon: Icon, label }) => (
              ...
              <p className="mt-4 text-center text-[11px] leading-relaxed text-muted-foreground">
                Google + DPDP/TRAI-first for India. US FTC endorsement rules are reflected where relevant to US activity.
                See <a href="/privacy" className="underline underline-offset-2">Privacy</a> and{" "}
                <a href="/terms" className="underline underline-offset-2">Terms</a> for data, AI-subprocessor and messaging details.
              </p>
            </div>
          </div>
        </div>
