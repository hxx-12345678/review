...
import { LayoutDashboard, QrCode, Settings, ShieldCheck, ExternalLink, LogOut, CreditCard, BarChart3 } from "lucide-react"
...
export function DashboardSidebar() {
  ...
  return (
    <aside className="hidden w-64 shrink-0 flex-col border-r border-border bg-sidebar sticky top-0 h-screen md:flex">
